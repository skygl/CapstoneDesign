...
if(isset($_POST['formData'])) {
    ...
    //print_r($_POST);
    for ($i = 0 ; $i < sizeof($searcharray['name']) ; $i++){
    //    setcookie("checkloop", $i);;
	    ...
	    $present_int = 0;
            ...
            $query = "INSERT INTO attendance VALUES (  '".$student_id_fin."' , '".$class_id_fin."', '".$sessionVal."', '".$present_int."')
             ON DUPLICATE KEY UPDATE isPresent='".$present_int."'";
    ...
    ###
    $cmd = "sudo python3 /home/jh/check_attendance.py $class_id_fin $sessionVal";
